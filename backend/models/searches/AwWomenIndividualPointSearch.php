...
/**
 * AwWomenIndividualPointSearch represents the model behind the search form about `app\models\AwWomenIndividualPoint`.
 */
class AwWomenIndividualPointSearch extends AwWomenIndividualPoint
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AwWomenIndividualPoint::find();
