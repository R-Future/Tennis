...
/**
 * AwSinglePointSearch represents the model behind the search form about `app\models\AwSinglePoint`.
 */
class AwSinglePointSearch extends AwSinglePoint
{
    /**
     * @inheritdoc
     */
