...
/**
 * AwDoublePointSearch represents the model behind the search form about `app\models\AwDoublePoint`.
 */
class AwDoublePointSearch extends AwDoublePoint
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'team', 'total_matches', 'win_matches', 'margin_bureau', 'point'], 'integer'],
