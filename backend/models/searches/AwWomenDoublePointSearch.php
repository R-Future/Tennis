...
/**
 * AwWomenDoublePointSearch represents the model behind the search form about `common\models\AwWomenDoublePoint`.
 */
class AwWomenDoublePointSearch extends AwWomenDoublePoint
{
    /**
     * @inheritdoc
     */
