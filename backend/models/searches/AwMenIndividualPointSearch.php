...
/**
 * AwMenIndividualPointSearch represents the model behind the search form about `app\models\AwMenIndividualPoint`.
 */
class AwMenIndividualPointSearch extends AwMenIndividualPoint
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AwMenIndividualPoint::find();
