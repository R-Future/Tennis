...
/**
 * AwMixedDoublePointSearch represents the model behind the search form about `common\models\AwMixedDoublePoint`.
 */
class AwMixedDoublePointSearch extends AwMixedDoublePoint
{
    /**
     * @inheritdoc
     */
